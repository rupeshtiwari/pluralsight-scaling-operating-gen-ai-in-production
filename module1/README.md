...
|---|-------|--------|---------------------|---------|
| 2 | Build the FastAPI provider adapter layer | 6 min | TO1, EO1a | [demo/m1-demo2-provider-adapter-layer.md](demo/m1-demo2-provider-adapter-layer.md) ✅ |
| 3 | Prove weighted routing across model tiers | 6 min | EO1b | [demo/m1-demo3-weighted-routing.md](demo/m1-demo3-weighted-routing.md) ✅ |
| 5 | Prove payload-based routing and deterministic overrides | 6 min | EO1c, EO1d | [demo/m1-demo5-payload-routing-and-overrides.md](demo/m1-demo5-payload-routing-and-overrides.md) ✅ |
| 6 | Validate routing receipts, counters, and final disposition | 6 min | TO1, EO1a–d | [demo/m1-demo6-routing-receipts-and-disposition.md](demo/m1-demo6-routing-receipts-and-disposition.md) ✅ |
...
# follow demo/m1-demo2-provider-adapter-layer.md, demo/m1-demo3-weighted-routing.md, or demo/m1-demo5-payload-routing-and-overrides.md
...
preflight per demo (`m1-demo2-provider-adapter-layer.preflight.sh`,
`m1-demo3-weighted-routing.preflight.sh`,
`m1-demo5-payload-routing-and-overrides.preflight.sh`, and
`m1-demo6-routing-receipts-and-disposition.preflight.sh`) that runs every step,
