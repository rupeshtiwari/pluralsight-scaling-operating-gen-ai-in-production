...
|---|-------|--------|---------------------|---------|
| 2 | Prove queues, rate limits, and fail-fast behavior | 6 min | TO2, EO2a, EO2b, EO2e | [demo/clip2-queues-rate-limits.md](demo/clip2-queues-rate-limits.md) ✅ |
| 3 | Prove circuit breaker fallback and retry backoff | 6 min | EO2c, EO2d, EO2e | [demo/clip3-circuit-breaker.md](demo/clip3-circuit-breaker.md) ✅ |
| 5 | Prove traces, logs, metrics, and quality sampling | 6 min | EO3a–e | [demo/clip5-observability.md](demo/clip5-observability.md) ✅ |
| 6 | Diagnose latency, quota pressure, cost drift, and quality regression | 6 min | TO2, EO2e, TO3, EO3a–e | [demo/clip6-incident-diagnosis.md](demo/clip6-incident-diagnosis.md) ✅ |
