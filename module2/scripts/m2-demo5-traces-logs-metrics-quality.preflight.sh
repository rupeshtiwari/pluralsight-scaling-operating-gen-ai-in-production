...
# AUTHOR PREFLIGHT: runs every demo step in the SAME order as module2/demo/m2-demo5-traces-logs-metrics-quality.md,
...
cd "$ROOT"
LOG="$ROOT/preflight-logs/m2-demo5-traces-logs-metrics-quality.log"
: > "$LOG"
...
blank
emit "  ${GRAY}full readable log written to:${R} ${LGRN}preflight-logs/m2-demo5-traces-logs-metrics-quality.log${R}"
exit "$FAIL"
