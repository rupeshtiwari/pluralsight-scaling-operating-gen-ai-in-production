#!/usr/bin/env bash
# Start the Module 3 stack and open a tmux window ready to run the demo.
#
...
SESSION="genai-m3"
LIME=$'\033[38;2;2;224;136m'; PINK=$'\033[38;2;255;22;117m'
BLUE=$'\033[38;2;0;163;255m'; LGRN=$'\033[38;2;235;239;245m'; R=$'\033[0m'
...
bash "$ROOT/scripts/module3-demo-reset.sh" || true
...
echo "  ${BLUE}1.${R} Follow the steps in ${LGRN}module3/demo/m3-demo1-prompt-versioning-rollback.md${R} (run them from ${LGRN}${ROOT}${R})"
echo "  ${BLUE}2.${R} Reset any time with ${LGRN}./scripts/module3-demo-reset.sh${R}"
echo "  ${BLUE}3.${R} When finished, stop everything with ${LGRN}bash module3/scripts/demo_down.sh${R}"
