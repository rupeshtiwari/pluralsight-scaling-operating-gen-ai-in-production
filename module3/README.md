...
|---|-------|--------|---------------------|---------|
| 2 | Prove prompt versioning and reproducible rollback | 6 min | TO4, EO4a | [demo/clip2.md](demo/clip2.md) _(planned)_ |
| 3 | Validate model updates against quality baselines | 6 min | EO4b | [demo/clip3.md](demo/clip3.md) _(planned)_ |
| 5 | Prove canary promotion, hold, and rollback decisions | 6 min | EO4c | [demo/clip5.md](demo/clip5.md) _(planned)_ |
| 6 | Run readiness audit and finalize operational runbook proof | 6 min | EO4d, TO5, EO5a–d | [demo/clip6.md](demo/clip6.md) _(planned)_ |
