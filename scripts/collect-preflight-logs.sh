...
map=(
  "module1/preflight_log.txt=m1-demo2-provider-adapter-layer.log"
  "module1/clip3_preflight_log.txt=m1-demo3-weighted-routing.log"
  "module1/clip5_preflight_log.txt=m1-demo5-payload-routing-and-overrides.log"
  "module1/clip6_preflight_log.txt=m1-demo6-routing-receipts-and-disposition.log"
  "module2/clip2_preflight_log.txt=m2-demo2-queues-rate-limits-failfast.log"
  "module2/clip3_preflight_log.txt=m2-demo3-circuit-breaker-fallback-retry.log"
  "module2/clip5_preflight_log.txt=m2-demo5-traces-logs-metrics-quality.log"
  "module2/clip6_preflight_log.txt=m2-demo6-diagnose-latency-quota-cost-quality.log"
  "module3/clip2_preflight_log.txt=m3-demo2-prompt-versioning-rollback.log"
  "module3/clip3_preflight_log.txt=m3-demo3-model-update-validation.log"
  "module3/clip5_preflight_log.txt=m3-demo5-canary-promotion-rollback.log"
  "module3/clip6_preflight_log.txt=m3-demo6-readiness-audit-runbook.log"
)
